...
-- Deklarasi fungsi navigasi agar dapat saling memanggil secara bertingkat
local menuUtama, tampilkanDialogLogin
local buatRepoDialog, tambahFileRepoDialog
local daftarRepoSayaDialog, kelolaRepoPilihanDialog, bukaDirektoriRepoDialog, menuAksiFile, formEditIsiBerkas
...
kelolaRepoPilihanDialog = function(repoObj, token)
  ...
  local subMenus = {
    ...
    "3. Salin tautan halaman repositori",
    "4. Bagikan tautan repositori",
    "5. Buka repositori di browser"
  }
...
-- 3. Penjelajah Berkas & Sub-folder Repositori
...
-- 4. Menu Aksi untuk Berkas Spesifik
...
-- Dialog Menambah Berkas Baru (Tombol dipaksa huruf kecil: "simpan berkas")
tambahFileRepoDialog = function(token, repoOtomatis, repoObj)
  ...
  -- Mengunci teks tombol agar tetap menggunakan huruf kecil murni
